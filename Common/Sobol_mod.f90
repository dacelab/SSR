...
!     integer ( kind = 4 ) i4_bit_lo0
   ...
   !
   !    The input arguments to this function should NOT be constants; they
   !    should be variables of type integer ( kind = 8 )!
   !
   !  Example:
   !
   !       N    Binary    Hi 1
...
!     integer ( kind = 8 ) :: i8_bit_lo0
   ...
   !
   !  Expand this bit pattern to separate components of the logical array
   !  INCLUD
         j = poly(i)
         do k = m, 1, - 1
           j2 = j / 2
   ...
   !
     ...
     integer ( kind = 4 ) j
     real ( kind = 8 ), dimension ( m, n ), intent(out) :: r
     integer ( kind = 8 ) seed
...
!     real ( kind = 8 ) r8i8_uniform_01
   ...
   !  Parameters:
   !
   !    Input, integer ( kind = 4 ) DIM_NUM, the spatial dimension.  Only
   !    values of 1 through 13 will result in useful responses.
   !
